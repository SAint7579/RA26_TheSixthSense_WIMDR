...
function geocodePostion(pos){
  ...
  function (results, status){
   ...
   if(status == google.maps.GeocoderStatus.OK){
         ...
         console.log(results);
         latitudelocation1=results[0].geometry.location.lat();
         longitudelocation1=results[0].geometry.location.lng();
         location1=results[2].address_components[1].long_name + ", " +results[2].address_components[2].long_name ;
         console.log(latitudelocation1);
         console.log(longitudelocation1);
